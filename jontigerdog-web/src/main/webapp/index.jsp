...
<html ng-app="DemoApp">
    <head>
        <meta charset="UTF-8">
        <title>Jontigerdoghatfield artwork</title>
    ...
    <script>
        ...
        .controller('DemoCtrl', function($scope, $timeout) {
            ...
            $scope.slides2 = [];
            $scope.slideIndex = 0;
            // pre-defined method of adding digit named files
            // addSlides($scope.slides2, 'optional-url-segment', 9);
            addSlide($scope.slides2, 'Unfathomable-Thoughts-Of-The-Secretly-Artistic-Lady');
            addSlide($scope.slides2, 'Lady-Reflecting-On-The-World');
            addSlide($scope.slides2, 'Puking-My-Guts-Up');
            addSlide($scope.slides2, 'Cattallion-Battallion');
            addSlide($scope.slides2, 'Cosmic-Bewilderment');
            addSlide($scope.slides2, 'Desecration-Of-Fictional-Holiness-By-The-Pure-And-Holy-Animals');
            addSlide($scope.slides2, 'Drawing-Of-Intelligent-Man');
            addSlide($scope.slides2, 'Emphatic-Release-Of-Endorphins');
            addSlide($scope.slides2, 'Jay-Kay');
